Afin d'utiliser le CRM : 
> récupérer l'ensemble des fichiers
> installer un environnement virtuel
> installer les applications contenues dans requirements.txt (commande sur la console : pip install -r requirements.txt
)
